			...
			<table id="tb1">
				...
				<tbody>
					<tr>
						...
						<td><input type="hidden" name="bid" value=${book.id}>
						<span id="span00">${book.title}</span></td>
					</tr>
					<tr>
					...
					<tr>
						<td id="td1" colspan="2">해당 교재를 반납하시겠습니까?</td>
					</tr>
					<tr>
						<td id="td0"><strong>확인</strong></td>
						<td>
							<button type="submit" name="confirm" value="1" formmethod="post"
								style="color: #777">예</button>
							<button type="submit" name="confirm" value="0" formmethod="post"
								style="color: #777">아니오</button>
						</td>
					</tr>
				</tbody>
			</table>
